...
class HttpMetricSnapshotAssemblerTest {
    ...
    void setUp() {
        ...
        assembler = new HttpMetricSnapshotAssembler(queryService, clock, fanoutExecutor);
    }
    ...
    void assemble_runsQueriesOnVirtualThreads() {
        ...
        PrometheusResponse successResponse = buildResponse(
            List.of(endpointSeries("myapp", "host:8080", "/api/v1/a", "0.05")));
